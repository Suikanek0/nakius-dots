...
hl.bind(mainMod .. " + SHIFT + S", hl.dsp.exec_cmd("hyprshot -z -m region -m active --clipboard-only"))
...
-- moving focus through vim binds
hl.bind(mainMod .. " + H", hl.dsp.focus({ direction = "left" }))
hl.bind(mainMod .. " + L", hl.dsp.focus({ direction = "right" }))
hl.bind(mainMod .. " + K", hl.dsp.focus({ direction = "up" }))
hl.bind(mainMod .. " + J", hl.dsp.focus({ direction = "down" }))
-- left right moving windows
...
-- moving windows non scrolling layout
...
--move through workspaces with vim binds
hl.bind(mainMod .. " + CTRL + SHIFT + K", hl.dsp.focus({ workspace = "e-1" }))
hl.bind(mainMod .. " + CTRL + SHIFT + J", hl.dsp.focus({ workspace = "e+1" }))
